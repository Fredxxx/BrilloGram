...
anglePara.end = 60 #deg
anglePara.res = 10 #deg
...
# psScoh, psSinc, psfSinc, psE, psD, com_pScoh_1D, com_tScoh_1D, com_tSinc_1D, com_pSinc_1D, com_tE_1D, com_pE_1D, com_tD_1D, com_pD_1D = calcPScom(psfE, psfD, theta, phi)
...
#     plt.grid(True)
#     plt.tight_layout()
#     plt.savefig(path + name + "_angularPowerDistribution1D.png", dpi=300, bbox_inches='tight')
#     np.savetxt(path + name + "_angularPowerDistribution1D.txt", histT, fmt='%.5f')
#     #plt.show()
...
#     plt.savefig(path + name + "_angularPowerDistribution2D.png", dpi=300, bbox_inches='tight')
#     np.savetxt(path + name + "_angularPowerDistribution2D.txt", hist, fmt='%.5f')
#     #plt.show()
...
#     plt.tight_layout()
#     plt.savefig(path + name2 + "_maxProj.png", dpi=300, bbox_inches='tight')
#     np.save(path + name2 + '_Vol.npy', arr)
#     #plt.show()

# saveMaxProj(psfE, sexy, angle, "psf", "excitationPSF", path)
# saveMaxProj(psfD, sexy, angle, "psf", "detectionPSF", path)
# saveMaxProj(psfSinc, sexy, angle, "psf", "systemIncPSF", path)
# saveMaxProj(psE, kxy, angle, "powSpec", "excitationPS", path)
# saveMaxProj(psD, kxy, angle, "powSpec", "detectionPS", path)
# saveMaxProj(psSinc, kxy, angle, "powSpec", "systemIncPS", path)
# saveMaxProj(psScoh, kxy, angle, "powSpec", "systemCohPS", path)

# e = time.time()
# print(f"Time - final: {e - ser} s")
